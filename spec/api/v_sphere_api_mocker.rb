...
def vim_vm_mock(name, power_state: 'poweredOn', vm_ware_tools: 'toolsNotInstalled', boot_time: Time.now - 60*60*24, heartbeat_status: 'green',
  ...
  allow(vm).to receive(:guestHeartbeatStatus).and_return(heartbeat_status)
