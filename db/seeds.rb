...
User.create(email: 'employee@employee.de', password: '123456', first_name: 'Wissenschaftlicher', last_name: 'Mitarbeiter', role: :employee)
Project.create(name: 'Test Project', description: 'Test Project Description')
